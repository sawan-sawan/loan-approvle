...
for i in range(1, 601):
    ...
    affordability = (loan_amount / loan_term) / applicant_income
    ...
    score += 2 if applicant_income >= 70000 else (1 if applicant_income >= 45000 else -2)
    ...
    rows.append([
        i, applicant_income, loan_amount, loan_term,
        credit_history, employment_status, loan_status
    ])

with OUTPUT.open("w", newline="", encoding="utf-8") as file:
    writer = csv.writer(file)
    writer.writerow([
        "Loan_ID", "Applicant_Income", "Loan_Amount", "Loan_Term",
        "Credit_History", "Employment_Status", "Loan_Status"
    ])
